...
final class DebateOrchestrator
{
    ...
    private const DEBATE_LOG = '/var/www/html/storage/evolution/debate_log.jsonl';
...
USR;
    ...
    {
        $k = trim((string) $this->config->get('ai.openai.api_key', $this->config->get('assistant.api_key', '')));
    ...
    {
        $k = trim((string) ($this->config->get('evolution.anthropic.api_key') ?? ''));
