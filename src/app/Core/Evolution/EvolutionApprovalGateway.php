...
{
    private const APPROVALS_DIR  = '/var/www/html/storage/evolution/approvals';
    private const GUARD_BINARY   = '/var/www/html/storage/evolution/evolution_guard';
    ...
    {
        $logFile = '/var/www/html/storage/evolution/monthly_spend.json';
        if (!is_file($logFile)) {
            return 0.0;
        }
