...
{
    private const VITALS_LOG   = '/var/www/html/storage/evolution/web_vitals.jsonl';
    private const TRAFFIC_LOG  = '/var/www/html/storage/evolution/traffic_spikes.jsonl';
    private const SCALE_LOCK   = '/var/www/html/storage/evolution/traffic_scale.lock';
