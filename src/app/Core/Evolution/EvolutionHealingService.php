...
{
    private const AUDIT_LOG = '/var/www/html/storage/evolution/healing_audit.jsonl';
    ...
    {
        $cacheDir = (string) ($this->config->get('app.view.cache') ?? 'public/storage/cache/twig');
    ...
    {
        $sessDir = '/var/www/html/public/storage/sessions';
        if (!is_dir($sessDir)) {
    ...
    {
        $tmpDir = '/var/www/html/public/storage/tmp';
        if (!is_dir($tmpDir)) {
    ...
    {
        $pidFile = '/var/www/html/storage/evolution/scheduler.pid';
        if (!is_file($pidFile)) {
    ...
    {
        $logDir = '/var/www/html/storage/evolution';
        if (!is_dir($logDir)) {
