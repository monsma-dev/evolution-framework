...
{
    private const VAULT_DIR   = '/var/www/html/storage/evolution/swarm_vault';
    private const INDEX_FILE  = '/var/www/html/storage/evolution/swarm_vault/index.jsonl';
    private const STATS_FILE  = '/var/www/html/storage/evolution/swarm_vault/stats.json';
