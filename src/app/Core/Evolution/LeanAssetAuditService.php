...
final class LeanAssetAuditService
{
    ...
    public function analyze(Config $config): array
    {
        ...
        $rel = is_array($fe) ? (string) ($fe['css_file'] ?? 'public/storage/evolution/architect-overrides.css') : 'public/storage/evolution/architect-overrides.css';
        ...
        $twigRoots = [BASE_PATH . '/src/resources/views'];
        $haystack = '';
        $twigCount = 0;
