...
{
    private const STATE_FILE    = '/var/www/html/storage/evolution/circuit_state.json';
    private const SNAPSHOT_DIR  = '/var/www/html/storage/evolution/skill_snapshot';
    private const QUEUE_FILE    = '/var/www/html/storage/evolution/ghost_queue.json';
    private const HEALTH_FILE   = '/var/www/html/storage/evolution/provider_health.json';
    ...
    {
        if (is_dir('/var/www/html/src/evolution/skills')) {
            return '/var/www/html/src/evolution/skills';
        }
        return (defined('BASE_PATH') ? BASE_PATH : dirname(__DIR__, 3)) . '/src/evolution/skills';
    }
