...
{
    private const SKILLS_DIR = '/var/www/html/src/evolution/skills';
    private const FALLBACK_DIR_RELATIVE = 'src/evolution/skills';
    private const INDEX_FILE = '/var/www/html/storage/evolution/skill_tfidf_index.json';
